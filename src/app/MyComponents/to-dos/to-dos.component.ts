...
//-----------------------------------------------------------------------------------------
  ...
  inputValuedesc!:string
 editingTodo: any = null; // Track the todo being edited

  editClick(Todo:Todo){
       this.edit=false;
       this.editingTodo = Todo;
      this.inputValuetitle=Todo.title;
      this.inputValuedesc=Todo.desc;
  }
  updateClick(Todo:Todo){
   
     console.log('update function called');
     Todo.title=this.inputValuetitle;
     Todo.desc=this.inputValuedesc;
     this.edit=true;
     localStorage.setItem('todosherekey', JSON.stringify(this.todoshere));
     this.editingTodo= null; 
  }
  cancelClick(Todo:Todo){
    this.edit=true;
  }
